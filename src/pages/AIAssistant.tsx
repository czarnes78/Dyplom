...
import { Send, Sparkles, MessageCircle, Loader, MapPin, Calendar, Users } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Asystent AI - Doradca Podróży</h1>
          <p className="text-lg text-gray-600">
            Powiedz mi, o czym marzysz, a ja znajdę dla Ciebie idealną wycieczkę
          </p>
        </div>
